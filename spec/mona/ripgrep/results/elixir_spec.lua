describe("mona.ripgrep.results.elixir", function()
   ...
   describe("module", function()
      it("should return parsed ripgrep output", function()
         local ripgrep_output = "mona_test_project/lib/mona_test_project.ex:1:1:MonaTestProject"
      ...
      it("should not return parsed ripgrep output if output is nil or empty", function()
