describe("telescope._extensions.mona.config", function()
   ...
   describe("setup", function()
      describe("merging user config with the user extension config", function()
         ...
         it("should preserve values from the user extension config on key missing", function()
            config.values = {
               pickers = {
                  [config.included_pickers_name] = {
                     theme = "dropdown",
   ...
   describe("merge", function()
      describe("merging config with the picker config, theme config and picker opts", function()
         it("should extend exisiting dictionaries on key collision", function()
            config.values = {
               extensions = {
                  mona = {
            ...
            assert.same(expected_result.pickers[config.included_pickers_name].theme, result.theme)
         ...
         it("should preserve values from the picker opts on key missing", function()
            config.values = {
               pickers = {
                  [config.included_pickers_name] = {
                     theme = "dropdown",
         ...
         it("should merge a theme config using the theme set on the picker config", function()
            config.values = {
               theme = "dropdown",
            }
         ...
         it("should merge a theme config using the theme set on the picker opts", function()
            config.values = {
               theme = "dropdown",
